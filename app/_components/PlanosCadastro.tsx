...
// IDs devem bater com a tabela `planos` do Supabase e com o mapa em app/dashboard/page.tsx
export const PLANOS_EMPRESA: Plano[] = [
...
export const PLANOS_PESSOAIS: Plano[] = [
...
type Props = {
  ...
  linkAlternativo: { href: string; texto: string };
};
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <h2 className="text-2xl font-bold text-gray-900 mb-8 text-center">{tituloSecao}</h2>
        <div className={`grid grid-cols-1 gap-6 mb-12 mx-auto ${gridClassName}`}>
          {planos.map((plano) => (
        ...
        <p className="text-center mb-12">
          <Link href={linkAlternativo.href} className="text-blue-600 hover:underline font-bold">
        ...
        {modalAberto && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-lg p-8 max-w-md w-full">
              ...
              <input
                type="text"
                placeholder={placeholderNomeConta}
                value={nomeEmpresa}
